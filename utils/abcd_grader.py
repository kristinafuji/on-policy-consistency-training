# Vendored verbatim from openai/gpt-oss (Apache-2.0):
#   https://github.com/openai/gpt-oss/blob/main/gpt_oss/evals/abcd_grader.py
#
# Priority-ordered regex cascade for extracting A/B/C/D answers from
# reasoning-model outputs. Used as a fallback when the simple-evals
# "Answer: $LETTER" sentinel doesn't match.
