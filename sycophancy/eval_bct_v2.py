#!/usr/bin/env python3
"""
Evaluation script for sycophancy with TWO-PHASE GENERATION and LOGIT EXTRACTION.

Phase 1: Generate thinking tokens (up to thinking_max_tokens), stopping at ####
Phase 2: Prefill "#### " and extract logits for A, B, C, D via topk_prompt_logprobs
...
class Config:
    ...
    thinking_mode: Literal["enable", "disable"] | None = "enable"

    # Two-phase generation settings
    two_phase_thinking: bool = True  # Enable two-phase generation
    thinking_max_tokens: int = 2048  # Phase 1 budget

    dedupe_unbiased: bool = True

    dataset_name: str = "<hf-username>/MMLU_Test_V3"
    dataset_split: str = "test"
    output_dir: str = "./eval_results_MMLU_Test_V3"
